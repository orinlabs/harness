...
class BlueRedShoesMedium(Simulation):
    name = "blue-red-shoes-medium"
    description = (
    ...
    memory_seed = MemorySeed(
        generate=MemorySeedInstruction(
            instruction=(
                ...
                "helping Jake Martinez, a friendly software engineer, across four weeks "
                "(day -27 through day -1). Fill in a normal life: work updates, gym, "
                "cooking experiments, friends (Lisa Chen, Carlos Reyes, Will Okonkwo, "
                "Danny Huang, Nina Patel), dog adoption (Cooper), 10K training, "
                "apartment hunting, guitar practice, TV shows. Include mundane personal "
                "moments (grocery runs, commute, chores). The pinned entries mention "
                "Jake's red shoes \u2014 do NOT mention shoes, shoe color, footwear, or "
                "anything shoe-related in any generated entry."
            ),
