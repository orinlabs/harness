...
class BlueRedShoesHeavy(Simulation):
    name = "blue-red-shoes-heavy"
    description = (
    ...
    memory_seed = MemorySeed(
        generate=MemorySeedInstruction(
            instruction=(
                "Generate realistic five-minute summaries for an AI assistant's daily "
                "life helping Jake Martinez, a software engineer, across four weeks "
                "(day -27 through day -1). Fill in dense, varied activity: work "
                "(API migration, code reviews, standups), gym (10K training), social "
                "(friends Lisa Chen, Carlos Reyes, Will Okonkwo, Danny Huang, Nina "
                "Patel \u2014 each with their own storylines), dog adoption (Cooper the "
                "lab mix), cooking experiments, guitar practice, apartment hunting, "
                "TV shows (Severance), family (mom, dad's retirement party, sister). "
                "Make it very dense \u2014 multiple entries per day. The pinned entries "
                "mention Jake's red shoes \u2014 do NOT mention shoes, shoe color, "
                "footwear, or anything shoe-related in any generated entry."
            ),
